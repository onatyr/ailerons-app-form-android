...
class ContextViewModel(fusedLocationClient: FusedLocationProviderClient): ViewModel() {
    ...
    val requestLocation = fusedLocationClient.lastLocation.addOnSuccessListener { lastLocation : Location -> // Attention, peut faire planter dans de rare cas car nullable
